...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Common+Extended/Common_Extended.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UIPanGestureRecognizerDirection/UIPanGestureRecognizerDirection.framework"
fi
